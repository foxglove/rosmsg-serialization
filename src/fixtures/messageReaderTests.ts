...
type MessageReaderTest = [msgDef: string, arr: Iterable<number>, expected: Record<string, unknown>];

const messageReaderTests: MessageReaderTest[] = [
  ...
  [
    ...
    { stamp: { sec: 4294967295, nsec: 4294967294 } },
  ],
  [
    `duration stamp`,
